...
parser.add_argument('--run', type=int, default=50)
...
while True:
    ...
    log_dir = '/data/calibration/log/%s/coeff=%.2f-kl=%.2f-recalib=%r-run=%d/' % (args.dataset, args.coeff, args.klcoeff, args.recalibrate, args.run)
